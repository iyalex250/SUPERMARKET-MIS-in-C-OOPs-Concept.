/* SUPERMARKET Shop Management System Project Source Code
Developed by Adam using concepts of file handling and oops concepts in c++

CPANEL CREDENTIALS::
......
E-mail: webmaster@icloud.com
Password: admin@101
        ...
        case 1 :
            {
                ...
                if(email == "webmaster@icloud.com" && password == "admin@101") 
                {
